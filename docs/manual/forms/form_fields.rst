...
.. note::
   Wanneer je een waarde uit een sleutel-waarde variabele wilt gebruiken, kan je het
   beste gebruik maken van de :ref:`template tag <manual_templates_template_tags>`
   ``get_value``.
   ...
   .. code:: python
      ...
      partner = {"voornaam": "Alice"}

   Dan kun je een veld toevoegen met:

   * **Eigenschapnaam**: ``partnerGeboortedatum``
   * **Label**: ``Geboortedatum {% get_value partner 'voornaam' %}``
