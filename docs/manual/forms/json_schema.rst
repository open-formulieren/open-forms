...
:doc:`Objecten API- </configuration/registration/objects>` of
:doc:`Generieke JSON-registratie </configuration/registration/generic-json>`. De fieldset van de plugin bevat een knop
waarmee een venster kan worden geopend. Hierin is het gegenereerde schema beschikbaar is in een JSON-editor.
