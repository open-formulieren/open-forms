...
:class:``openforms.authentication.contrib.yivi_oidc.view.AuthenticationInitView``.
...
.. autoclass:: openforms.authentication.contrib.yivi_oidc.view.AuthenticationInitView
   :members:
