...
available via Sentry - losing tracebacks of failed tasks is not concern. Additionally,
we don't have complex workflows that rely on the task results to continue execution.
