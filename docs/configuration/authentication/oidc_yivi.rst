...
.. important:: Alle verzoeken aan Yivi vereisen het gebruik van Yivi-attributen. Ook voor
   ...
   Raadpleeg de `Yivi Attribute Index <https://portal.yivi.app/attribute-index>` voor een
   volledig overzicht van alle beschikbare attributen.
...
3. Vul bij **Attributen** de Yivi-attributen toe die tijdens het inloggen bevraagd moeten
   worden. De beschikbare attributen zijn te vinden in de
   `Yivi Attribute Index <https://portal.yivi.app/attribute-index>`.
