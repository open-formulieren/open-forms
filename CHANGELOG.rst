...
.. warning:: Schedule the upgrade for off-peak hours. Some of the database migrations
   ...
   .. todo:: get benchmark for yubin migration

   .. todo:: test duration of ``forms.0110`` again!
...
* [:backend:`5618`] Add support for WMS on map image in submission pdf.
...
* Fix sync variables resetting modified items.
* [:backend:`5624`] Added missing tag to the StUF-BG template for children (family-members plugin).
