...
type IbanTranslatableProperties = Literal["label", "description", "tooltip"]

IbanExtensions = BaseOpenFormsExtensions[IbanTranslatableProperties]
...
class Iban(Component, tag="iban"):
    ...
    validate: IbanValidate = msgspec.field(default_factory=IbanValidate)
