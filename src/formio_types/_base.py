...
from typing import TYPE_CHECKING, Annotated, Literal, TypeVar, dataclass_transform

import msgspec

from openforms.typing import VariableValue

from ._templating import TestWithTrace, trace
...
class Component(msgspec.Struct, metaclass=ComponentMeta):
    ...
    @property
    def type(self) -> str:
        from . import TYPE_TO_TAG

        return TYPE_TO_TAG[type(self)]
