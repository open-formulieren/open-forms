...
def forward(apps, schema_editor):
    ...
    for stuf_service in StufService.objects.all():
        ...
        soap_service.client_certificate.public_certificate = stuf_service.certificate
        soap_service.client_certificate.private_key = stuf_service.certificate_key
...
def backwards(apps, schema_editor):
    ...
    for stuf_service in StufService.objects.all():
        ...
        stuf_service.certificate = soap_service.client_certificate.public_certificate
        stuf_service.certificate_key = soap_service.client_certificate.private_key
