...
class CustomerFields(TextChoices):
    ...
    """
    Customer's Gender, one of Not specified (0), Male (1) or Female (2).
    """
...
def get_component(component_type: CustomerFields, required: bool):
    FIELD_TO_FORMIO_COMPONENT: dict[CustomerFields, Component] = {
        CustomerFields.gender: {
            ...
            "values": [  # pyright: ignore[reportAssignmentType]
                {"value": "M", "label": _("Male")},
                {"value": "F", "label": _("Female")},
                {"value": "N", "label": _("Not specified")},
            ],
        },
    ...
    return FIELD_TO_FORMIO_COMPONENT[component_type]
