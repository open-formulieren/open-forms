...
class PluginTests(OFVCRMixin, TestCase):
    ...
    RECORDING_DATETIME = "2025-10-24T12:34:56+02:00"
    ...
    def test_get_available_products_all(self):
        ...
        # Not sure how consistent this test data will be... :/
    ...
    def test_get_times(self):
        ...
        # product and location, so just ensure all datetime are from today
