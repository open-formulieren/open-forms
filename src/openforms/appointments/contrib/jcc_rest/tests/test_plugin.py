...
from ....base import AppointmentDetails, Product
...
class JccRestPluginTests(OFVCRMixin, TestCase):
    ...
    RECORDING_DATETIME: str = "2026-01-07T08:32:56+02:00"
    ...
    def test_required_customer_fields_when_optional_are_present(self, m):
        # TODO
    ...
    def test_required_customer_fields_with_invalid_products(self):
        ...
        # first name and last name are by default added to the required fields because of
        # the defaultSettings of the JCC response (customer/customerfields/all)
        # {
        #     "initials": 1,
    ...
    def test_required_customer_fields_with_isAnyPhoneNumberRequired(self, m):
        # TODO
        # Check if such an example has been added to the JCC test instance and replace
        # the mocked response
        ...
        # mobilePhoneNumber is hidden so we fall back to the mainPhoneNumber field
        self.assertEqual(
            required_fields,
            [
                {
    ...
    def test_required_customer_fields_with_isAnyPhoneNumberRequired_and_both_fields_required(
        ...
        """
        There is the possibility to have isAnyPhoneNumberRequired set to True and both
        mainPhoneNumber and mobilePhoneNumber set to required (2). In this situation we
        should see both fields in the form as required.
        """
        # TODO
        # Check if such an example has been added to the JCC test instance and replace
        # the mocked response
    ...
    # TODO
    # Remove the decorator when all the methods in the plugin are implemented
    @expectedFailure
