...
def _fetch_prefill_values(
    ...
    @elasticapm.capture_span(span_type="app.prefill")
    def invoke_plugin(
        item: Tuple[str, dict[str, list[str]]]
    ) -> Tuple[str, Dict[str, Any]]:
        plugin_id, field_groups = item
