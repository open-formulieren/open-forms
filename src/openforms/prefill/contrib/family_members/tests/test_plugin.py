...
class FamilyMembersPrefillPluginHCV2Tests(OFVCRMixin, TestCase):
    ...
    def test_partners_prefill_happy_flow(self):
        ...
        FormVariableFactory.create(
            key="hc_prefill_partners",
            form=submission.form,
            prefill_plugin=PLUGIN_IDENTIFIER,
            prefill_options={
                "type": "partners",
                "form_variable": "hc_prefill_partners",
                "min_age": None,
                "max_age": None,
            },
        )
        ...
        self.assertEqual(
            state.variables["hc_prefill_partners"].value,
            {
                "partners": [
                    {
                        "bsn": "999970136",
    ...
    def test_children_prefill_happy_flow(self):
        ...
        FormVariableFactory.create(
            key="hc_prefill_children",
            form=submission.form,
            prefill_plugin=PLUGIN_IDENTIFIER,
            prefill_options={
                "form_variable": "hc_prefill_children",
                "type": "children",
                "min_age": None,
                "max_age": None,
            },
        ...
        self.assertEqual(
            state.variables["hc_prefill_children"].value,
            {
                "children": [
                    {
                        "bsn": "999970409",
    ...
    def test_children_deceased(self):
        ...
        FormVariableFactory.create(
            key="hc_prefill_deceased_child",
            form=submission.form,
            prefill_plugin=PLUGIN_IDENTIFIER,
            prefill_options={
                "form_variable": "hc_prefill_deceased_child",
                "type": "children",
                "min_age": None,
                "max_age": None,
        ...
        self.assertEqual(
            state.variables["hc_prefill_deceased_child"].value,
            {
                "children": [
                    {
                        "bsn": "999970409",
...
class FamilyMembersPrefillPluginStufBgTests(TestCase):
    ...
    def test_partners_prefill_happy_flow(self):
        ...
        FormVariableFactory.create(
            key="stuf_bg_prefill_partners",
            form=submission.form,
            prefill_plugin=PLUGIN_IDENTIFIER,
            prefill_options={
                "type": "partners",
                "form_variable": "stuf_bg_prefill_partners",
                "min_age": None,
                "max_age": None,
            },
        )
        ...
        self.assertEqual(
            state.variables["stuf_bg_prefill_partners"].value,
            {
                "partners": [
                    {
                        "bsn": "123123123",
    ...
    def test_children_prefill_happy_flow(self):
        ...
        FormVariableFactory.create(
            key="stuf_bg_prefill_children",
            form=submission.form,
            prefill_plugin=PLUGIN_IDENTIFIER,
            prefill_options={
                "type": "children",
                "form_variable": "stuf_bg_prefill_children",
                "min_age": None,
                "max_age": None,
            },
        )
        ...
        self.assertEqual(
            state.variables["stuf_bg_prefill_children"].value,
            {
                "children": [
                    {
                        "bsn": "456789123",
