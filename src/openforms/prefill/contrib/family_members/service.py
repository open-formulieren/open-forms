...
def check_unmatched_variables() -> str:
    live_forms = Form.objects.live()  # type: ignore[PylancereportAttributeAccessIssue]
    ...
    for form in live_forms:
        ...
        for component in components:
            if component["type"] == "partners":
                partners_component_variables.append(component["key"])
    ...
    for variable in fm_immutable_variables:
        if (
            ...
            unmatched_variables.append(variable.name)
