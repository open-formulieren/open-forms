...
class CommunicationPreferencesAPITests(OFVCRMixin, SubmissionsMixin, APITestCase):
    ...
    def test_api_endpoint_authenticated_with_bsn_prefill_found(self):
            ...
            [
                {
                    ...
                    "options": [
                        ...
                        {
                            "emailAddress": "someemail@example.org",
                            "verificationDate": None,
                        },
                        {
                            "emailAddress": "devilkiller@example.org",
                            "verificationDate": None,
                        },
                    ],
                ...
                },
                {
                    ...
                    "options": [
                        {
                            "phoneNumberAddress": "0612345678",
                            "verificationDate": None,
                        },
                        {
                            "phoneNumberAddress": "0687654321",
                            "verificationDate": None,
                        },
                    ],
    ...
    def test_api_endpoint_authenticated_with_kvk_prefill_found(self):
        profile_channels: list[SupportedChannels] = ["email", "phoneNumber"]
        form = FormFactory.create(
            generate_minimal_setup=True,
            formstep__form_definition__configuration={
            ...
            [
                {
                    ...
                    "options": [
                        {
                            "emailAddress": "maykinmail@test.com",
                            "verificationDate": None,
                        }
                    ],
            ...
            [
                {
                    ...
                    "options": [
                        {
                            "emailAddress": "maykinmailvestiging@test.com",
                            "verificationDate": None,
                        }
                    ],
