...
class SubmissionFileAttachmentFactory(factory.django.DjangoModelFactory):
    ...
    # FIXME: this field is not required, so should not be generated by default
    ...
    submission_variable = factory.SubFactory(
        "openforms.submissions.tests.factories.SubmissionValueVariableFactory",
        submission=factory.LazyAttribute(
            lambda o: o.factory_parent.submission_step.submission
        ),
    )
