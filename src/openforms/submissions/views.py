...
class ResumeFormMixin(TemplateResponseMixin):
    ...
    def is_auth_data_correct(self, submission: Submission) -> bool:
        ...
        is_auth_attribute_correct = is_same_login_attribute(submission, self.request)
        is_auth_data_correct = is_same_login_value(submission, self.request)
