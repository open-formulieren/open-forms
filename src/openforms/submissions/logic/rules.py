...
def iter_evaluate_rules(
    ...
    :arg data_for_hidden_state: Initial data for clear-on-hide behavior.
    ...
    # We need to keep this isolated from data_for_hidden_state, as this contains values that
    # should be applied when a component goes from visible -> hidden.
