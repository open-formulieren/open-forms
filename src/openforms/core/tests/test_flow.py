...
class FormFlowTests(SeleniumStepTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.step_2 = FormStepFactory(form=self.form, form_definition=self.definition_2)
        self.step_3 = FormStepFactory(form=self.form, form_definition=self.definition_3)
    ...
    def test_submit_flow(self):
        ...
        self.assertEqual(submission_steps[1].form_step, self.step_1)
