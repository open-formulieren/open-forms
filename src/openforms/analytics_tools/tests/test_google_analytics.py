...
class GoogleAnalyticsTests(AnalyticsToolsMixinTestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.json_csp = [
            {"directive": "script-src", "value": "https://www.googleanalytics.com"},
            {"directive": "script-src", "value": "https://www.googletagmanager.com"},
        ]
