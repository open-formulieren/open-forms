...
class BrokenConfigurationTests(TestCase):
    ...
    @patch(
        ...
        return_value=HaalCentraalConfig(
            brp_personen_service=None,
            brp_personen_version=None,
        ),
    )
    def test_partners_with_no_service_collected(self, m, n):
        form = FormFactory.create(
            generate_minimal_setup=True,
            formstep__form_definition__configuration={
                "components": [
        ...
        self.assertEqual(
            ...
            [
                BrokenConfiguration(
                    config_name="Haal centraal Client",
                    exception_message="Service not selected",
                )
            ],
        )
    ...
    def test_no_partners_component_not_collected(self, m):
        form = FormFactory.create(
            generate_minimal_setup=True,
            formstep__form_definition__configuration={
                "components": [
    ...
    def test_partners_and_no_immutable_variable_connected_not_collected(self, m):
        FormFactory.create(
            generate_minimal_setup=True,
            formstep__form_definition__configuration={
                "components": [
