...
class ZGWRegistration(BasePlugin[RegistrationOptions]):
    ...
    def register_submission(
        ...
        if RegistrationAttribute.partners in initiator_rol_data:
            partners_rol_data = {
                "partners": initiator_rol_data[RegistrationAttribute.partners]
            }
            del initiator_rol_data[RegistrationAttribute.partners]
        ...
        with (
            ...
            if partners_rol_data:
                ...
                for index, data in enumerate(
                    partners_rol_data[RegistrationAttribute.partners]
                ):
        ...
        if partners_rol_data:
            result["partners_rollen"] = partners_rol_data
