...
class ZGWApiGroupConfigFactory(factory.django.DjangoModelFactory):
    ...
    zrc_service = factory.SubFactory(
        "zgw_consumers_ext.tests.factories.ServiceFactory", api_type=APITypes.zrc
    )
    drc_service = factory.SubFactory(
        "zgw_consumers_ext.tests.factories.ServiceFactory", api_type=APITypes.drc
    )
    ztc_service = factory.SubFactory(
        "zgw_consumers_ext.tests.factories.ServiceFactory", api_type=APITypes.ztc
    )
