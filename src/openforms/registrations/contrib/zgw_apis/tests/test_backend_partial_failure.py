...
# TODO-2324: this test does not give clear errors, only that the `intermediate_results`
#  do no contain a 'objects_api_object' key. It's best to comment this out and look at
#  other tests for debugging
# @temp_private_root()
