...
class EmailBackendTests(HTMLAssertMixin, TestCase):
    ...
    def test_user_defined_variables_included(self):
        submission = SubmissionFactory.from_components(
            ...
            components_list=[],
            submitted_data={
                "user_defined_var1": "test1",
                "user_defined_var2": "test2",
            },
            form__registration_backend="email",
        )
        SubmissionValueVariableFactory.create(
            form_variable__form=submission.form,
            form_variable__key="user_defined_var1",
        ...
        SubmissionValueVariableFactory.create(
            form_variable__form=submission.form,
            form_variable__key="user_defined_var2",
            form_variable__source=FormVariableSources.user_defined,
            submission=submission,
        ...
        self.assertIn("user_defined_var1: test1", message_text)
        self.assertIn("user_defined_var2: test2", message_text)
