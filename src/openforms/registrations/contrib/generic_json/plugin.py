...
def build_post_process_component_hook(
    ...
    :param use_empty_string_for_empty_datelike_variables: When ``True``, empty values
      for date, datetime and time variables will be emitted as empty string rather than
      ``null``.
    """
