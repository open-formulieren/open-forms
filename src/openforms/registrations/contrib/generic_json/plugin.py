...
# TODO-5312: the schema processing can be completely removed here if we are are OK with
#  the schema being a bit ambiguous for file components with multiple false:
#  `"type": ["null", "object"]`
