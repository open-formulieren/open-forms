...
class GenericJSONBackendTests(OFVCRMixin, TestCase):
    ...
    def test_children_components_schema(self):
        submission = SubmissionFactory.from_components(
            [{"key": "children", "type": "children"}],
            completed=True,
            submitted_data={
                "children": [
                    {
    ...
    def test_children_components_schema_with_two_steps(self):
        submission = SubmissionFactory.from_components(
            [
                {"key": "children", "type": "children"},
                {
        ...
        expected_values = {
            "children": [
                {"bsn": "999970100", "dateOfBirth": "2022-02-02", "firstNames": "Olle"},
                {"bsn": "999970112", "dateOfBirth": "2022-02-02", "firstNames": "Onne"},
            ],
            "childrenImmutable": [
                {
                    "affixes": "",
