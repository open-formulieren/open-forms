...
class StufZDSPluginChildrenComponentVCRTests(OFVCRMixin, StUFZDSTestBase):
    ...
    def test_create_zaak_with_one_form_step_and_children_as_betrokkene(self):
        ...
        children_paths = {
            "//zkn:object/zkn:heeftAlsOverigBetrokkene[@stuf:entiteittype='ZAKBTROVR']/zkn:gerelateerde/zkn:natuurlijkPersoon/bg:inp.bsn": 1,
            "//zkn:object/zkn:heeftAlsOverigBetrokkene[@stuf:entiteittype='ZAKBTROVR']/zkn:gerelateerde/zkn:natuurlijkPersoon/bg:authentiek": 1,
            "//zkn:object/zkn:heeftAlsOverigBetrokkene[@stuf:entiteittype='ZAKBTROVR']/zkn:gerelateerde/zkn:natuurlijkPersoon/bg:voornamen": 1,
            "//zkn:object/zkn:heeftAlsOverigBetrokkene[@stuf:entiteittype='ZAKBTROVR']/zkn:gerelateerde/zkn:natuurlijkPersoon/bg:voorletters": 1,
            "//zkn:object/zkn:heeftAlsOverigBetrokkene[@stuf:entiteittype='ZAKBTROVR']/zkn:gerelateerde/zkn:natuurlijkPersoon/bg:geslachtsnaam": 1,
            "//zkn:object/zkn:heeftAlsOverigBetrokkene[@stuf:entiteittype='ZAKBTROVR']/zkn:gerelateerde/zkn:natuurlijkPersoon/bg:geboortedatum": 1,
        }

        for path, count in children_paths.items():
            self.assertXPathCount(xml_doc, path, count)
                    ...
                    "action": {
                        ...
                        "config": {
                            ...
                            "children_mappings": [
                                {
                                    "property": "id_bsn",
                                    "component_key": "extraChildDetails.bsn",
                                },
                                {
                                    "property": "id_firstNames",
                                    "component_key": "extraChildDetails.childName",
                                },
                            ],
                        },
                    },
