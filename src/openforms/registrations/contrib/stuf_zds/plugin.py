...
class StufZDSRegistration(BasePlugin[RegistrationOptions]):
    ...
    def update_registration_with_confirmation_email(
        ...
        logger.info("stuf_zds_finalise_registration_started", options=options)
        res = get_last_confirmation_email(submission)
        if res is None:
            logger.warning(
                "stuf_zds_finalise_registration_aborted",
        ...
        # TODO-4877: do we need to return a separate dictionary?
