# Generated by Django 4.2.21 on 2025-06-16 09:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    mozilla_django_oidc_db.fields.ClaimField(
                        ...
                        help_text="Claim that specifies how the person identifier claim must be interpreted. The expected claim value is one of: 'bsn', 'pseudo' or 'national id'.",
                        size=None,
                ...
                (
                    ...
                    mozilla_django_oidc_db.fields.ClaimField(
                        ...
                        help_text="Claim that specifies how the company identifier claim must be interpreted. The expected claim value is one of: 'kvk', 'rsin', 'vat', 'lei', 'eori', 'ntr' or 'opaque'.",
                        size=None,
                        verbose_name="company identifier type claim",
                    ),
                ),
                (
                    "company_name_claim",
            ...
            options={
                ...
                "verbose_name_plural": "eIDAS (OIDC)",
            },
        ),
    ]
