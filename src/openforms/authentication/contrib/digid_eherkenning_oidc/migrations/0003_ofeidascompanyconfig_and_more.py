# Generated by Django 4.2.21 on 2025-07-09 12:58
...
class Migration(migrations.Migration):
    dependencies = [
        ("digid_eherkenning_oidc", "0002_ofeidasconfig"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    mozilla_django_oidc_db.fields.ClaimField(
                        ...
                        help_text="Name of the claim holding the identifier of the acting subject.",
                        size=None,
                ...
                (
                    ...
                    mozilla_django_oidc_db.fields.ClaimField(
                        ...
                        help_text="Claim that specifies how the acting subject identifier claim must be interpreted. The expected claim value is one of: 'bsn', 'pseudo' or 'national_id'.",
                        size=None,
                        verbose_name="acting subject identifier type claim",
                    ),
                ),
                (
                    ...
                    mozilla_django_oidc_db.fields.ClaimField(
                        ...
                        help_text="Claim that holds the legal name of the acting subject.",
                        size=None,
                        verbose_name="acting subject first name claim",
                    ),
                ),
                (
                    ...
                    mozilla_django_oidc_db.fields.ClaimField(
                        ...
                        help_text="Claim that holds the legal family name of the acting subject.",
                        size=None,
                        verbose_name="acting subject family name claim",
                    ),
                ),
                (
                    ...
                    mozilla_django_oidc_db.fields.ClaimField(
                        ...
                        help_text="Claim that holds the legal birthdate of the acting subject.",
                        size=None,
                        verbose_name="acting subject date of birth claim",
                    ),
                ),
                (
            ...
            options={
                "verbose_name": "eIDAS for companies (OIDC)",
            },
        ),
        migrations.RemoveField(
            model_name="ofeidasconfig",
            name="company_identifier_claim",
        ),
        migrations.RemoveField(
            model_name="ofeidasconfig",
            name="company_name_claim",
        ),
        migrations.RemoveField(
            model_name="ofeidasconfig",
            name="date_of_birth_claim",
        ),
        migrations.RemoveField(
            model_name="ofeidasconfig",
        ...
        migrations.RemoveField(
            model_name="ofeidasconfig",
            name="person_identifier_claim",
        ),
        migrations.RemoveField(
            model_name="ofeidasconfig",
            name="person_identifier_type_claim",
        ),
        migrations.AddField(
            model_name="ofeidasconfig",
            ...
            field=mozilla_django_oidc_db.fields.ClaimField(
                ...
                size=None,
                verbose_name="legal subject date of birth claim",
            ),
        ),
        migrations.AddField(
            model_name="ofeidasconfig",
            ...
            field=mozilla_django_oidc_db.fields.ClaimField(
                ...
                size=None,
                verbose_name="legal subject family name claim",
            ),
        ),
        migrations.AddField(
            model_name="ofeidasconfig",
            ...
            field=mozilla_django_oidc_db.fields.ClaimField(
                ...
                size=None,
                verbose_name="legal subject first name claim",
            ),
        ),
        migrations.AddField(
            model_name="ofeidasconfig",
            ...
            field=mozilla_django_oidc_db.fields.ClaimField(
                ...
                size=None,
                verbose_name="legal subject identifier claim",
            ),
        ),
        migrations.AddField(
            model_name="ofeidasconfig",
            ...
            field=mozilla_django_oidc_db.fields.ClaimField(
                ...
                size=None,
                verbose_name="legal subject identifier type claim",
            ),
        ),
    ]
