...
class YiviOptionsSerializerTest(TestCase):
    ...
    def test_valid_options_with_multiple_authentication_optionss(self):
        serializer = YiviOptionsSerializer(
            data={
    ...
    def test_valid_options_with_empty_authentication_optionss(self):
        serializer = YiviOptionsSerializer(
            data={
                "authentication_options": [],
                "additional_scopes": [],
    ...
    def test_valid_options_with_no_authentication_optionss(self):
        serializer = YiviOptionsSerializer(
            data={
                "additional_scopes": [],
            },
