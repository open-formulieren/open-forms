...
class YiviPluginSensitiveClaimsTest(TestCase):
    """
    Testing the Yivi plugin ``sensitive_claims`` function.
    ...
    def test_all_configured_additional_attributes_are_present_in_the_sensitive_claims(
        self,
    ):
        AttributeGroupFactory(
            name="know_attributes", attributes=["firstname", "lastname"]
        ...
        sensitive_claims = plugin.sensitive_claims(plugin_options, claims=claims)
        self.assertEqual(
            sensitive_claims,
