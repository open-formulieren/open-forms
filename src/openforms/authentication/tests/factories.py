...
from ..contrib.yivi_oidc.models import AvailableScope, YiviOpenIDConnectConfig
...
class AvailableScopeFactory(factory.django.DjangoModelFactory):
    config = factory.SubFactory(YiviOpenIDConnectConfigFactory, id=1)
