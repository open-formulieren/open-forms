 ...
 * @param  {Object} catalogusUrl The catalogus URL the informatieobjecttypen should belong to.
 ...
 */
export const getInformatieObjectTypen = async (backend, options, catalogusUrl = '') => {
  const extraOptions = {};

  if (catalogusUrl) {
    extraOptions.catalogus_url = catalogusUrl;
  }
