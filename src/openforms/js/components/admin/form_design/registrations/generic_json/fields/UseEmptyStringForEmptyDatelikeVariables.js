  ...
  return (
    <FormRow>
      <Checkbox
        ...
        label={
          <FormattedMessage
            description="JSON registration options: useEmptyStringForEmptyDatelikeVariables label"
            defaultMessage="Use empty string for empty date, datetime and time values"
          />
        }
        helpText={
          <FormattedMessage
            description="JSON registration options: useEmptyStringForEmptyDatelikeVariables helpText"
