...
const ComplexProcessVariable = ({
  ...
  // state
  const [{type, definition, editPanelOpen, editVariable}, dispatch] = useImmerReducer(reducer, {
    ...initialState,
    type: initialType,
    definition: initialDefinition,
  });
...
ComplexProcessVariable.propTypes = {
  ...
  definition: PropTypes.oneOfType([PropTypes.object, PropTypes.array]).isRequired,
