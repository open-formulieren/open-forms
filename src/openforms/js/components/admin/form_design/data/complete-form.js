...
const processVariables = draft => {
  draft.formVariables = draft.formVariables
    ...
    .map(variable => {
      ...
      if (serviceFetchConfiguration) {
        serviceFetchConfiguration.service = serviceFetchConfiguration.serviceUuid;

        if (Array.isArray(serviceFetchConfiguration.headers)) {
          serviceFetchConfiguration.headers = Object.fromEntries(serviceFetchConfiguration.headers);
        }
