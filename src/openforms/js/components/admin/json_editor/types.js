...
const jsonPrimitives = ['string', 'number', 'boolean', 'null'];

export const jsonComplex = ['object', 'array'];
...
export const VariableSource = PropTypes.oneOf(['', 'manual', 'component', 'interpolate']);
