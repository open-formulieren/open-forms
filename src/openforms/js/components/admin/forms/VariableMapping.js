...
const VariableMappingRow = ({
  ...
  const variableError = errors && variableName in errors ? errors[variableName] : undefined;
  const propertyError = errors && propertyName in errors ? errors[propertyName] : undefined;
...
const VariableMapping = ({
  ...
  const relatedErrors = name in errors ? errors[name] : [];
  return (
    <FieldArray
      name={name}
      render={arrayHelpers => (
            ...
            <tbody>
              {mappings.map((_, index) => (
                <VariableMappingRow
                  ...
                  rowCheck={rowCheck}
                  errors={relatedErrors && relatedErrors[index] ? relatedErrors[index] : undefined}
                />
              ))}
            </tbody>
          </table>
