...
class BasePlugin(Generic[ComponentT], AbstractBasePlugin):
    ...
    def as_json_schema(component: ComponentT) -> JSONObject:
        """Return JSON schema for this formio component plugin. The format is as
        follows: {[component_key]: [component_properties]}. This means it can be added
        directly to the `properties` of a schema definition.
        """
