...
def _convert_legacy_component(component: Component) -> AnyComponent:
    try:
        _component: AnyComponent = msgspec.convert(component, type=AnyComponent)
...
def format_value(
    component: AnyComponent | Component, value: Any, *, as_html: bool = False
):
    """
...
def holds_submission_data(component: AnyComponent | Component) -> bool:
...
def get_component_empty_value(component: AnyComponent | Component) -> JSONValue:
    """
