...
from formio_types import AnyComponent, Columns, SoftRequiredErrors
...
class ComponentNode[ComponentT: AnyComponent](Node):
    ...
    def is_visible(self) -> bool:
        ...
        if isinstance(self.parent_node, EditGridGroupNode):
            if not self._is_visible_in_editgrid_item(formio_config):
                return False
    ...
    def _is_visible_in_editgrid_item(self, formio_config: FormioConfig) -> bool:
        from .default import EditGridGroupNode
    ...
    def apply_to_labels(self, f: Callable[[str], str]) -> None:
        ...
        match self.component:
            case Columns() | SoftRequiredErrors():
                pass
            case _:
