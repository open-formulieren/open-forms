...
class ComponentNode(Node):
    ...
    depth: int = 0
    is_layout = False
    path: str | None = None  # Path in the data (#TODO rename to data_path?)
    json_renderer_path: str | None = (
    ...
    def build_node(
        ...
        component: Component,
        renderer: "Renderer",
        path: str | None = None,  # Path in the data
        json_renderer_path: str | None = None,
        configuration_path: str = "",
        depth: int = 0,
        parent_node: Node | None = None,
    ) -> "ComponentNode":
