...
class FormEndpointTests(APITestCase):
    ...
    def test_create_detailed_form(self):
        ...
        self.assertEqual(variables[2].form_definition, form_definition)
        ...
        self.assertEqual(variables[3].form_definition, form_definition)
...
class FormEndpointVariableTests(APITestCase):
    ...
    def test_user_defined_variables(self):
        ...
        self.assertEqual(variables[1].form_definition.uuid, form_definition_uuid)
        self.assertEqual(variables[1].data_type, FormVariableDataTypes.string)
    ...
    def test_user_defined_without_form_definition(self):
        form_definition_uuid = uuid4()
        url = reverse(
            "api:v3:form-detail",
            kwargs={"uuid": "559812e7-9bff-4142-ab41-0cc8cf4e5e32"},
    ...
    def test_update_recreates_variables(self):
            ...
            "variables": [
                {
                    ...
                    "key": "extra_var",
                    "source": FormVariableSources.user_defined,
                    "formDefinition": form_step_3_definition_uuid,
                    "dataType": FormVariableDataTypes.string,
                },
            ],
        }
        ...
        self.assertEqual(variables[4].form_definition.uuid, form_step_3_definition_uuid)
    ...
    def test_static_variable_collision(self):
        ...
        self.assertEqual(error_message["name"], "variables.1.key")
    ...
    def test_user_defined_all_prefill_fields(self):
        ...
        self.assertEqual(error_message["name"], "variables.0.nonFieldErrors")
        self.assertEqual(
    ...
    def test_user_defined_unknown_form_definition(self):
        form_definition_uuid = uuid4()
        url = reverse(
            "api:v3:form-detail",
            kwargs={"uuid": "559812e7-9bff-4142-ab41-0cc8cf4e5e32"},
        ...
        error_message = response_data["invalidParams"][0]
        self.assertEqual(error_message["code"], "invalid")
        self.assertEqual(error_message["name"], "variables.0.formDefinition")
        self.assertEqual(
            error_message["reason"], _("Unknown form definition specified.")
        )

    def test_user_defined_no_form_definition_profile_form_variable(self):
        customer_interactions_api = CustomerInteractionsAPIGroupConfigFactory.create()
        form_definition_uuid = uuid4()
        url = reverse(
            "api:v3:form-detail",
        ...
        error_message = response_data["invalidParams"][0]
        self.assertEqual(error_message["code"], "invalid")
        self.assertEqual(error_message["name"], "variables.0.key")
        self.assertEqual(
            error_message["reason"],
            _("Profile variable has no form definition specified."),
        )
    ...
    def test_user_defined_profile_form_variable_incorrect_component_type(self):
        ...
        error_message = response_data["invalidParams"][0]
        self.assertEqual(error_message["code"], "invalid")
        self.assertEqual(error_message["name"], "variables.0.profileFormVariable")
        self.assertEqual(
            error_message["reason"],
            _(
    ...
    def test_multiple_profile_variables_same_component(self):
        ...
        self.assertEqual(error_message["code"], "unique")
        self.assertEqual(
            error_message["name"], "variables.1.prefillOptions.profileFormVariable"
        )
        self.assertEqual(
            error_message["reason"],
            _(
