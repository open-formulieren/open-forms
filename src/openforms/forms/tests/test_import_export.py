...
from ...authentication.tests.factories import AvailableScopeFactory
...
class ImportExportTests(TempdirMixin, TestCase):
    ...
    def test_import_form_with_yivi_auth_backend_with_unknown_additional_scopes(self):
        AvailableScopeFactory(scope="some_known_scope")
        resources = {
            "forms": [
                {
                    "active": True,
        ...
        self.assertEqual(
            auth_backend.options["additional_scopes"], ["some_known_scope"]
        )
