...
class FormVariableViewsetTest(APITestCase):
    ...
    @tag("gh-5142")
    def test_api_call_returns_submitted_variables(self):
        """
        Assert that the api endpoint returns list of submitted variables.
        ...
        variables, and we have to manually create a list of submitted variables to
