...
class ProcessVariableSchemaObjectsApiTests(TestCase):
    ...
    def test_file(self):
        ...
        process_variable_schema_objects_api(component, schema, self.options)
    ...
    def test_selectboxes_as_list(self):
        ...
        process_variable_schema_objects_api(component, schema, options)
...
class ProcessVariableSchemaGenericJsonTests(TestCase):
    ...
    def test_file(self):
        ...
        process_variable_schema_generic_json(component, schema, self.options)
    ...
    def test_selectboxes_as_list(self):
        ...
        process_variable_schema_generic_json(component, schema, options)
