...
from ..json_schema import generate_json_schema, generate_variable_schema
...
class GenerateVariableSchemaObjectsApiTests(TestCase):
    maxDiff = None
    ...
    def test_file(self):
        ...
        schema = generate_variable_schema(
            var, form_def.configuration_wrapper, "objects_api", self.options
        )
    ...
    def test_selectboxes_as_list(self):
        ...
        schema = generate_variable_schema(
            var, form_def.configuration_wrapper, "objects_api", options
        )
...
class GenerateVariableSchemaGenericJsonTests(TestCase):
    maxDiff = None
    ...
    def test_file(self):
        ...
        schema = generate_variable_schema(
            var, form_def.configuration_wrapper, "json_dump", self.options
        )
    ...
    def test_selectboxes_as_list(self):
        ...
        schema = generate_variable_schema(
            var, form_def.configuration_wrapper, "json_dump", options
        )
