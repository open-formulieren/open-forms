...
def disable_open_when_empty(apps, _):
    ...
    for form_definition in form_definitions:
        ...
        for comp in iter_components(configuration=form_definition.configuration):
            if comp["type"] != "editgrid" or not comp.get("openWhenEmpty", False):
                continue
            comp["openWhenEmpty"] = False
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(disable_open_when_empty, migrations.RunPython.noop),
    ]
