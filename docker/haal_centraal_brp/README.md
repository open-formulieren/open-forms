...
- create a patch file (_some-change-bsnNumber.patch_) and save it to open-forms/patches directory

  `git diff > some-change-bsnNumber.patch`
...
- apply the patch to your local json file
  ...
  `patch /path/to/test-data.json < some-change-bsnNumber.patch`
