...
COMPONENTS_TO_CHANGE = [
    "textfield", "radio", "selectboxes", "file", "checkbox", "editgrid", "signature"
]

# def print_all_default_none():
#     from openforms.forms.models import FormDefinition
#     from openforms.formio.utils import get_component_empty_value
#
#     for fd in FormDefinition.objects.iterator():
#         for component in fd.iter_components():
#             # if component["defaultValue"] is None:
#             if component["defaultValue"] != get_component_empty_value(component):
#                 print(component["defaultValue"], component["type"])
